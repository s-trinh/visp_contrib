...
public:
  ...
  static vpImage<unsigned char> binarize(const vpImage<vpRGBa> &I_color, const unsigned char threshold,
  ...
  static  vpImage<unsigned char> binarize(const vpImage<unsigned char> &I, const unsigned char threshold,
      const MORPHOLOGY_TYPE morphology=NO_MORPHOLOGY, const unsigned int kernelSize=1,
  ...
  static  vpImage<unsigned char> findContours(const vpImage<unsigned char> &I, const bool useOtsu=true,
      const unsigned char threshold=70);
  static  vpImage<unsigned char> findContours(const vpImage<vpRGBa> &I_color, const bool useHSV=false,
      const bool useOtsu=true, const unsigned char threshold=70);
  ...
  */
  ...
  void track(const vpImage<vpRGBa> &I_color, const bool useHSV=false,
    bool (*func)(vpHomogeneousMatrix *)=NULL, const PREDICTION_TYPE &predictionType=PROJECTION);
  void track(const vpImage<unsigned char> &I, const bool doBinarize=true,
      bool (*func)(vpHomogeneousMatrix *)=NULL, const PREDICTION_TYPE &predictionType=PROJECTION);
...
private:
  ...
  std::vector<vpBlobInfo> filterContours(const std::vector<std::vector<cv::Point> > contours);
